...
fn main() {
    ...
    app.run(move |cx| {
        ...
        cx.bind_keys([
            ...
            KeyBinding::new("cmd-0", FitView, Some("VecgraStudio")),
            KeyBinding::new("cmd-=", ZoomIn, Some("VecgraStudio")),
            KeyBinding::new("cmd--", ZoomOut, Some("VecgraStudio")),
            KeyBinding::new("cmd-1", ArrangeAuto, Some("VecgraStudio")),
            KeyBinding::new("cmd-2", ArrangeForce, Some("VecgraStudio")),
            KeyBinding::new("cmd-3", ArrangeOrbit, Some("VecgraStudio")),
            KeyBinding::new("cmd-4", ArrangeStructure, Some("VecgraStudio")),
            KeyBinding::new("cmd-shift-r", ReleaseSelected, Some("VecgraStudio")),
            KeyBinding::new("enter", ActivateSelection, Some("VecgraStudio")),
            KeyBinding::new("cmd-k", FocusSearch, Some("VecgraStudio")),
            KeyBinding::new("down", NextSearchResult, Some("VecgraStudio")),
            KeyBinding::new("up", PreviousSearchResult, Some("VecgraStudio")),
            KeyBinding::new("escape", ClearSelection, Some("VecgraStudio")),
        ]);
        ...
        let mut window_options = WindowOptions {
            ...
            app_id: Some("dev.vecgra.studio".into()),
        ...
        cx.spawn(async move |cx| {
            cx.open_window(window_options, move |window, cx| {
                ...
                window.set_window_title("Vecgra Studio");
                #[cfg(feature = "visual-test")]
            ...
            .expect("open the Vecgra Studio window");
        })
        .detach();
    });
}
...
fn capture_frame(window: &mut Window, cx: &mut App, capture_path: PathBuf) {
    ...
    match window.render_to_image() {
        Ok(image) => image
            .save(&capture_path)
            .expect("save the Vecgra Studio visual-test capture"),
        Err(error) => panic!("render the Vecgra Studio capture: {error}"),
    }
